...
#=======================================
# Kernel de cuda para simulaciom Montecarlo en el GPU
#========================================================
@cuda.jit
def calcularpi_kernel(rng_states, iteraciones, out):
    ii = cuda.grid(1)
    #======================================
    # Calcular pi dibujando puntos (x,y) al azar y encontrado
    ...
    #=============================================
    out[ii] = 4.0 * cae_adedntro / iteraciones
...
print(seed1)
seed2 = random.uniform(seed1)
print(seed2)
seed = random.uniform(-1000,1000)
print(seed)
rng_states = create_xoroshiro128p_states(hilosporbloque*bloque,seed)

#==============================
# Arreglo de salida (escritura)
#===============================
out = no.zeros(hilosporbloque*bloque, dtype=np,float64)
