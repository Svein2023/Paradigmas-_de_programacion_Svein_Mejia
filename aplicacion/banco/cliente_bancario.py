...
class ClienteBancario:
    ...
    def __mandarEmail(self, titulo:str, texto:str) -> None:
        print("mandar emai: "+ titulo + "con texto: " + texto)
    def __enviarBalanceAlBanco(self, cantidad:float) -> None:
        print("Enviado cantidad: " + str(cantidad) + "al banco...")
    ...
    #====================================
    # Metod privado que checa si el balance es negativo
    # y genera un error
    #==============================================
    ...
    def guardarDinero(self, cantidad:float)-> None:
        ...
        self.__mandarEmail("---- guardando deposito -----"," se recibieron " + 
str(cantidad))
